...
export async function PATCH(request: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const summaryJson = body.summaryJson !== undefined ? validateJsonDoc(body.summaryJson) ?? undefined : undefined;
    const summaryText = typeof body.summaryText === "string" ? body.summaryText.trim().slice(0, 10000) : undefined;
    const decisionsJson = body.decisionsJson !== undefined ? validateJsonDoc(body.decisionsJson) ?? undefined : undefined;
