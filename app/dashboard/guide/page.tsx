    ...
    <div className="guide-page page-enter">
      <section className="guide-hero">
        <div>
          ...
          <h1>Panduan kerja yang membuat pendampingan tetap rapi.</h1>
          <p>Gunakan halaman ini sebagai titik mulai semua tim. Satu client memiliki satu atau beberapa program; setiap program bergerak lewat task, meeting, dokumen, lalu invoice dan pembayaran.</p>
        </div>
      ...
      <section className="guide-rules surface">
        ...
        <div className="guide-rules-grid"><div><strong>Task</strong><span>TODO → IN PROGRESS → DONE. BLOCKED wajib punya alasan, owner, dan next review.</span></div><div><strong>Meeting</strong><span>Meeting FINAL wajib berisi ringkasan, keputusan, dan action item atau alasan kenapa tidak dibuat task.</span></div><div><strong>Dokumen</strong><span>Gunakan kategori yang benar dan simpan hasil di program terkait. File client bersifat privat.</span></div><div><strong>Keuangan</strong><span>Invoice terbit punya nomor unik. Pembayaran tidak dihapus; koreksi dilakukan lewat void dan alasan.</span></div></div>
      </section>
